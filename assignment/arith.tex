...
The answer to the questions should also appear in the notebook in text cells.
Feel free to do the exercises in any order you like.
...
\begin{exercise}
Write a function \texttt{fraction\_digits(p, q, b)} that assumes that $p < q$ and returns a pair of lists \texttt{[l1, l2]} where:
\begin{compactitem}
